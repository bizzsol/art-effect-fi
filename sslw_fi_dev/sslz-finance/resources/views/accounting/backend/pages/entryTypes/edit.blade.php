                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="icheck-primary d-inline">
                                    <input type="checkbox" id="companies_{{ $company->id }}" name="companies[]" value="{{ $company->id }}" {{ in_array($company->id, $entryType->companies->pluck('company_id')->toArray()) ? 'checked' : '' }}>
                                    <label for="companies_{{ $company->id }}" class="text-primary">
                                      {{ $company->name }}&nbsp;&nbsp;&nbsp;
                                    </label>
                                  </div>
                                  @endforeach
