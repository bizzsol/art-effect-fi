...
<script type="text/javascript">
    ...
    function getItems() {
        ...
        $.ajax({
            url: "{{ url('accounting/process-depreciation/create') }}?action=items&product_id="+$('#product_id').val()+"&fixed_asset_batch_id="+$('#fixed_asset_batch_id').val()+"&asset_code="+$('#asset_code').val()+"&year="+$('#year').val()+"&month="+$('#month').val(),
            type: 'GET',
            data: {},
        })
        .done(function(response) {
