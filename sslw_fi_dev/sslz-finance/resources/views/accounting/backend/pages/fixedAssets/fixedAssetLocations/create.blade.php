        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('accounting.fixed-asset-locations.store') }}" method="post" accept-charset="utf-8">
                    @csrf
                        <div class="row pr-3">
                            <div class="col-md-2 col-sm-12">
                                <label for="code"><strong>{{ __('Location Code') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="code" id="code" value="{{ old('code',$code) }}" class="form-control rounded" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <textarea name="address" id="address" class="form-control rounded">{{ old('address') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <label for="contact_for_deliveries"><strong>{{ __('Contact For Deliveries') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="contact_for_deliveries" id="contact_for_deliveries" value="{{ old('contact_for_deliveries') }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="mobile" id="mobile" value="{{ old('mobile') }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-md"><i class="la la-save"></i>&nbsp;Save Fixed Asset Locations</button>
                            </div>
                        </div>
                    </form>
                </div>
