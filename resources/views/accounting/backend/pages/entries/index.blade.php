                    ...
                    <li class="top-nav-btn">
                        @can('entry-create')
                            <div class="row">
                                ...
                                @can('entries-bulk-delete')
                                    <div class="col-md-3">
                                        <a class="btn btn-dark btn-sm" target="__blank"
                                           href="{{ route('accounting.entries.bulk-delete') }}"><i class="las la-trash-alt"></i>
                                            Bulk Delete</a>
                                    </div>
                                @endcan
                                <div class="col-md-3">
                                            ...
                                            @if(isset($entryTypes[0]))
                                                @foreach($entryTypes as $key => $entryType)
                                                    <a class="dropdown-item"
                                                       @if($companies->count() == 1) href="{{ url('accounting/entries/create?type='.$entryType->label.'&company='.$companies->first()->id) }}"
                                                       @else data-toggle="modal" data-target="#companyModal"
                                                       onclick="$('#type').val('{{ $entryType->label }}')"
                                                       @endif style="font-size: 14px;font-weight: 600">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 pt-4">
                                    <div class="btn-group mt-2" style="width: 100%">
                                        ...
                                        <a href="{{ url('accounting/entries') }}" class="btn btn-danger btn-sm"
