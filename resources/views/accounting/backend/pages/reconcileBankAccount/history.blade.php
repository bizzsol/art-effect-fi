    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="panel panel-info mt-2 p-3" style="padding-bottom: 0 !important;">
                <form action="{{ url('accounting/bank-reconciliation-history') }}" method="get" accept-charset="utf-8">
                    <div class="row mb-3">
                        <div class="col-md-5">
                            ...
                            <select name="bank_account_id" id="bank_account_id" class="form-control rounded">
                                ...
                                <option value="{{ $bankAccount->id }}" {{ request()->get('bank_account_id') == $bankAccount->id ? 'selected' : '' }}>{{ $bankAccount->name }} ({{$bankAccount->number}})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-6 pt-1">
                                    <button type="submit" class="mt-4 btn btn-block btn-success"><i class="la la-search"></i>&nbsp;Search</button>
                                </div>
                                <div class="col-md-6 pt-1">
                                    <button type="submit" class="mt-4 btn btn-block btn-danger"><i class="la la-times"></i>&nbsp;Reset</button>
                                </div>
                            </div>
                        </div>
                    </div>
