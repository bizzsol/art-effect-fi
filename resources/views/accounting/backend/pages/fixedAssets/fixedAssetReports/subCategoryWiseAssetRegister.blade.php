        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <div class="row pr-3">
                        <div class="col-md-12">
                            <form action="{{ url('accounting/sub-category-wise-asset-register') }}" method="get" accept-charset="utf-8" target="_blank">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="category_id"><strong>Category</strong></label>
                                            <div class="select-search-group input-group input-group-md mb-3 d-">
                                                <select name="category_id" id="category_id" class="form-control rounded select2 sub-category" required>
