...
<script type="text/javascript">
    ...
    function getStocks(){
        ...
        $.ajax({
            url: "{{ url('accounting/cwip-to-asset/create') }}?action=stocks&purchase_order_id="+$('#purchase_order_id').val(),
            type: 'GET',
            data: {},
        })
    ...
    function getCosts() {
        ...
        $.ajax({
            url: "{{ url('accounting/cwip-to-asset/create') }}?action=items&purchase_order_id="+$('#purchase_order_id').val()+"&goods_received_items_stock_in_id="+$('#goods_received_items_stock_in_id').val(),
            type: 'GET',
            data: {},
        })
        .done(function(response) {
