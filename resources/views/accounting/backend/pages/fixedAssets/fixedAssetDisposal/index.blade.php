...
<script type="text/javascript">
    ...
    function getProducts(){
        ...
        $.ajax({
            url: "{{ url('accounting/fixed-asset-disposal/create') }}?get-products&company_id="+$('#company_id').val(),
            type: 'GET',
            data: {},
        })
    ...
    function getItems() {
        ...
        $.ajax({
            url: "{{ url('accounting/fixed-asset-disposal/create') }}?action=items&product_id="+$('#product_id').val()+"&asset_code="+$('#asset_code').val()+"&currency_id="+$('#currency_id').val()+"&company_id="+$('#company_id').val(),
            type: 'GET',
            data: {},
        })
        .done(function(response) {
