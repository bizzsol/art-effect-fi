                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="text" name="number" id="number"
                                                               value="{{ old('number') }}" class="form-control rounded">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="text" name="name" id="name"
                                                               value="{{ old('name') }}" class="form-control rounded">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 pt-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <button type="submit" class="btn btn-success btn-md btn-block mt-2"><i class="la la-save"></i>&nbsp;Save Bank Accounts</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function getCOA() {
        ...
        $.ajax({
            url: "{{ url('accounting/bank-accounts/create') }}?get-coa&company_id="+$('#company_id').val(),
            type: 'GET',
            data: {},
        })
