        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('accounting.sub-processes.update', $subProcess->id) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="row pr-3">
                            <div class="col-md-5">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="name" id="name" value="{{ old('name', $subProcess->name) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="type" id="type" class="form-control">
                                        <option value="automatic" {{ $subProcess->type == 'automatic' ? 'selected' : '' }}>Automatic</option>
                                        <option value="manual" {{ $subProcess->type == 'manual' ? : '' }}>Manual</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-5">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="description" id="description" value="{{ old('description', $subProcess->description) }}" class="form-control rounded">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="process_id" id="process_id" class="form-control">
                                        ...
                                        <option value="{{ $process->id }}" {{ $subProcess->process_id == $process->id ? 'selected' : '' }}>{{ $process->code }} | {{ $process->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="source_id" id="source_id" class="form-control">
                                        ...
                                        <option value="{{ $source->id }}" {{ $subProcess->source_id == $source->id ? 'selected' : '' }}>{{ $source->code }} | {{ $source->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="control_point_id" id="control_point_id" class="form-control">
                                        ...
                                        <option value="{{ $controlPoint->id }}" {{ $subProcess->control_point_id == $controlPoint->id ? 'selected' : '' }}>{{ $controlPoint->code }} | {{ $controlPoint->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="requirement_id" id="requirement_id" class="form-control">
                                        ...
                                        <option value="{{ $requirement->id }}" {{ $subProcess->requirement_id == $requirement->id ? 'selected' : '' }}>{{ $requirement->code }} | {{ $requirement->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="entry_point_id" id="entry_point_id" class="form-control" onchange="getLedgers()">
                                        ...
                                        <option value="{{ $entryPoint->id }}" {{ $subProcess->entry_point_id == $entryPoint->id ? 'selected' : '' }}>{{ $entryPoint->code }} | {{ $entryPoint->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="debit_percentages[{{ $ledger->chart_of_account_id }}]" value="{{ $ledger->percentage }}" class="form-control">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="ledger-{{ $ledger->id }}"><strong>[{{ $ledger->chartOfAccount->code }}] {{ $ledger->chartOfAccount->name }} ({{ $ledger->type == 'D' ? 'Dr.' : 'Cr.' }}) (%)</strong></label>
                                            <input type="number" name="credit_percentages[{{ $ledger->chart_of_account_id }}]" value="{{ $ledger->percentage }}" class="form-control">
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-md"><i class="la la-save"></i>&nbsp;Update Sub-Process</button>
                            </div>
                        </div>
                    </form>
                </div>
