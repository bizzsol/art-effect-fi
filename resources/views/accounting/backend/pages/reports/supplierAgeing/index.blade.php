...
<div class="main-content">
             ...
             <div id="accordion">
              <div class="card">
                ...
                <div id="filter" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                  <div class="card-body">
                    <form action="{{ url('accounting/supplier-ageing') }}" method="get" accept-charset="utf-8" id="report-form">
                    <input type="hidden" name="report_type" id="report_type" value="report">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="profit_centre_id" id="profit_centre_id" class="form-control" onchange="getSuppliers()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pt-4">
                                ...
                                @include('accounting.backend.pages.reports.buttons', [
                                    'url' => url('accounting/supplier-ageing?chart_of_account_id='.request()->get('chart_of_account_id').'&from='.request()->get('date')),
                                ])
                            </div>
                        </div>
                        </form>
    ...
    <div class="col-md-12 report-search p-2 bg-white" style="display: none">
        <input type="text" placeholder="Search Supplier Names here..." class="form-control search-report" onchange="searchReport($(this))" onkeyup="searchReport($(this))">
    </div>
