            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info mt-2 p-2">
                        <form action="{{ url('accounting/ledger-wise-receipts-payments') }}" method="get" accept-charset="utf-8" id="report-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    @can('ledger-wise-receipts-payments-excel')
                                        @include('accounting.backend.pages.reports.buttons', [
                                            'title' => "Ledger-wise Receipts & Payments Statement",
                                            'url' => url('accounting/ledger-wise-receipts-payments'),
                                            'normalExcel' => true,
                                        ])
                                    @endcan
                                </div>
