  ...
  <body>
    ...
    <div class="container">
      <table class="table table-bordered">
         <tr>
            <td style="width: 15%;font-size: 12px !important"><strong>Code</strong></td>
            <td style="width: 45%;font-size: 12px !important"><strong>Ledger</strong></td>
            <td style="width: 20%;font-size: 12px !important" class="text-right"><strong>Opening Balance</strong></td>
            <td style="width: 20%;font-size: 12px !important" class="text-right"><strong>Closing Balance</strong></td>
         </tr>
         {!! $trialBalance !!}
      </table>
    </div>
