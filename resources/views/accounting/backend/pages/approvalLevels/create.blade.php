            ...
            <div class="page-content">
                <div class="panel panel-info mt-3">
                    <div class="panel-boby p-3">
                        <form action="{{ route('accounting.approval-levels.store') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <button type="submit" class="btn btn-success btn-md"><i class="la la-save"></i>&nbsp;Save Approval Level</button>
                                </div>
                            </div>
                        </form>
                    </div>
