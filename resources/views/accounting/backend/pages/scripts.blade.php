...
$(document).ready(function() {
    ...
    $.each($('.open-button'), function(index, val) {
        var header = $(this).parent().parent().find('.iq-card-header');
        var body = $(this).parent().parent().find('.iq-card-body');
        $(this).click(function(event) {
            header.find('.open-button').hide();
            header.find('.close-button').show();
            body.fadeIn('slow');
        });
    });

    $.each($('.close-button'), function(index, val) {
        var header = $(this).parent().parent().find('.iq-card-header');
        var body = $(this).parent().parent().find('.iq-card-body');
        $(this).click(function(event) {
            header.find('.close-button').hide();
            header.find('.open-button').show();
            body.fadeOut('slow');
        });
    });
