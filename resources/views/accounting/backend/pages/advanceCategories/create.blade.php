        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('accounting.advance-categories.store') }}" method="post" accept-charset="utf-8">
                    @csrf
                        <div class="row pr-3">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-6">
                                <label for="chart_of_account_id"><strong>{{ __('Choose Ledger') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-md"><i class="la la-save"></i>&nbsp;Save Advance Category</button>
                            </div>
                        </div>
                    </form>
                </div>
