            ...
            <div class="page-content">
                <div class="panel panel-info mt-3">
                    <div class="panel-boby p-3">
                        <form action="{{ route('accounting.cheque-books.store') }}" method="post"
                                        ...
                                        <div class="card-body bordered">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <label for="book_number"><strong>{{ __('Book Number') }}:<span
                                                                    class="text-danger">&nbsp;*</span></strong></label>
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="text" name="book_number" id="book_number" value=""
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="date" name="receiving_date" id="receiving_date"
                                                               value="{{ date('Y-m-d') }}" class="form-control rounded">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="page_number_from"><strong>{{ __('Starting Page Number') }}
                                                            :<span class="text-danger">&nbsp;*</span></strong></label>
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="number" name="page_number_from"
                                                               id="page_number_from" value=""
                                                               class="form-control rounded">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="page_number_to"><strong>{{ __('Ending Page Number') }}
                                                            :<span class="text-danger">&nbsp;*</span></strong></label>
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <input type="number" name="page_number_to" id="page_number_to"
                                                               value="" class="form-control rounded">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 pl-0 mb-2">
                                                <button type="submit" class="btn btn-success btn-md"><i
                                                            class="la la-save"></i>&nbsp;Save Cheque Books
                                                </button>
