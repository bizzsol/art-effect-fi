            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="top-nav-btn">
                        <a href="javascript:history.back()" class="btn btn-danger btn-sm"><i class="las la-arrow-left"></i>
                            Back</a>
                    </li>
                </ul>
            </div>
                                            ...
                                            <div class="form-group">
                                                <h5 class="pl-2">
                                                    <label style="cursor: pointer"><input type="checkbox"
                                                            name="bank_or_cash" value="1"
                                                            style="transform: scale(1.5, 1.5);cursor: pointer">&nbsp;&nbsp;&nbsp;Bank
                                                        or cash account</label>
                                                </h5>
                                            ...
                                            <div class="form-group">
                                                <h5 class="pl-2">
                                                    <label style="cursor: pointer"><input type="checkbox"
                                                            ...
                                                            style="transform: scale(1.5, 1.5);cursor: pointer">&nbsp;&nbsp;&nbsp;Reconciliation</label>
                                                </h5>
                                                ...
                                                <select name="currency_id" id="currency_id" class="form-control rounded">
                                                    ...
                                                    <optgroup label="{{ $currencyType->name }}">
                                                        ...
                                                        <option value="{{ $currency->id }}" {{
                                                            $accountDefaultSettings['currency_id']==$currency->id ?
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <textarea name="notes" id="notes" class="form-control rounded"
                                                style="min-height: 60px">{{ old('notes') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Users with an Accounts role are loaded automatically
                                            from the selected companies. You can also search any Accounts user by
                                            name, phone or email.</small>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="is_manual_transaction_allowed"><strong>Manual
                                                Transaction:</strong></label>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="is_manual_transaction_allowed" id="is_manual_transaction_allowed"
                                                class="form-control">
                                        ...
                                        @if(isset($entryTypes[0]))
                                            @foreach($entryTypes as $entryType)
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="entry_type_{{ $entryType->id }}" name="entry_types[]"
                                                        value="{{ $entryType->id }}">
                                            ...
                                            @foreach($companies as $company)
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="company{{ $company->id }}" name="companies[]"
                                                        value="{{ $company->id }}" class="companies">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($approvalLevels[0]))
                                            @foreach($approvalLevels as $level)
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" id="level{{ $level->id }}" name="approval_levels[]"
                                                        value="{{ $level->id }}">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <button type="submit" class="btn btn-success btn-md"><i
                                            class="la la-save"></i>&nbsp;Save Ledger Account</button>
                                </div>
                            </div>
                        </form>
                    </div>
