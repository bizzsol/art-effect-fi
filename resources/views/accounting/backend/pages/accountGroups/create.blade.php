                    ...
                    @csrf
                        <div class="row pr-3">
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="account_class_id" id="account_class_id" class="form-control rounded">
                                        ...
                                        <option value="{{ $this_class->id }}">{{ $this_class->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="code" id="code" value="{{ old('code') }}" class="form-control rounded" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row pr-3">
                            <div class="col-md-2">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="group_code_starts_at" id="group_code_starts_at" value="{{ old('group_code_starts_at', 0) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label for="group_code_ends_at"><strong>{{ __('Group Code Ends at') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="group_code_ends_at" id="group_code_ends_at" value="{{ old('group_code_ends_at', 0) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label for="coa_code_starts_at"><strong>{{ __('Ledger Code Starts From') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="coa_code_starts_at" id="coa_code_starts_at" value="{{ old('coa_code_starts_at', 0) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label for="coa_code_ends_at"><strong>{{ __('Ledger Code Ends at') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="coa_code_ends_at" id="coa_code_ends_at" value="{{ old('coa_code_ends_at', 0) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-4 text-right pt-4">
                                ...
                                <button type="submit" class="btn btn-success btn-md mt-2"><i class="la la-save"></i>&nbsp;Save Account Group</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    function getCode() {
        $.ajax({
            url: '{{ url('accounting/account-groups') }}/'+$('#parent_id').val(),
            type: 'GET',
            data: {},
        })
        .done(function(code) {
