        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('accounting.loans.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="loan-form">
                    @csrf
                        <div class="row">
                            <div class="col-md-9">
                                <div class="row">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="loan_type_id" id="loan_type_id" class="form-control rounded">
                                                ...
                                                @foreach($loanTypes as $key => $loanType)
                                                    <option value="{{ $loanType->id }}">{{ $loanType->name }}</attribute>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="bank_account_id" id="bank_account_id" class="form-control rounded">
                                                ...
                                                @foreach($bankAccounts as $key => $bankAccount)
                                                    <option value="{{ $bankAccount->id }}">{{ $bankAccount->name }} ({{ $bankAccount->number }}) ({{ $bankAccount->currency ? $bankAccount->currency->name : '' }})</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="row">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="cycle" id="cycle" class="form-control rounded">
                                                @foreach(loanCycles() as $key => $loanCycle)
                                                    <option value="{{ $key }}">{{ $loanCycle['name'] }}</attribute>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="number" name="principal" id="principal" value="0.00" class="form-control text-right" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="interest_rate"><strong>{{ __('Interest Rate (%)') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="number" name="interest_rate" id="interest_rate" value="0.00" class="form-control text-right" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="number_of_installments"><strong>{{ __('Number of Installments') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="number" name="number_of_installments" id="number_of_installments" value="0" class="form-control text-right" min="0">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="number" name="installment_amount" id="installment_amount" value="0.00" class="form-control text-right" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="first_instalment_date"><strong>{{ __('First Instalment Date') }}:<span class="text-danger">&nbsp;*</span></strong></label>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="date" name="first_instalment_date" id="first_instalment_date" class="form-control" min="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="date" name="interest_calculation_starts_from" id="interest_calculation_starts_from" class="form-control" min="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-md mb-3 d-">
                                        <textarea name="desc" id="desc" class="form-control" style="height: 120px;resize: none"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-md save-button"><i class="la la-save"></i>&nbsp;Save Loans</button>
                            </div>
                        </div>
                    </form>
                </div>
