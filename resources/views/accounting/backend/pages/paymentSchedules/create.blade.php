        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('accounting.payment-schedules.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="schedule-form">
                    @csrf
                        <div class="row pr-3">
                            <div class="col-md-3">
                        ...
                        <div class="row pr-3">
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <textarea name="description" id="description" class="form-control rounded" style="min-height: 130px">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
