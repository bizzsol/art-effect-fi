...
return [
    ...
    'logo' => 'https://bizzsol.com.bd/erp/images/bizz-logo-lg.png',
    ...
    'title' => 'Bizzpack(Finance) API Documentation',

    'description' => 'Bizzpack(Finance) API specification and documentation.',
